...
This project investigates the use of unsupervised anomaly machine learning techniques for credit card fraud detection. Due to how rare frauds cases are, the models were trained without using fraud labels and were assessed on their ability to identify anomalous transactions.
